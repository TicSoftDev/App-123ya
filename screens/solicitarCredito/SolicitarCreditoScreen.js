...
const SolicitarCreditoScreen = () => {
    ...
    return (
        <ScrollView className="flex-1 bg-gray-50">
            ...
            >
                <Text className="text-white text-3xl font-bold">Solicitar Crédito</Text>
            </LinearGradient>
            ...
            >
                ...
                <View className="mb-8">
                    <Text className="text-2xl font-bold text-gray-800 mb-4">Resumen de Préstamo</Text>
                    <View className="flex-row flex-wrap justify-between">
                        <View className="w-[48%] bg-blue-50 rounded-2xl p-4 mb-4">
                            <MaterialCommunityIcons name="cash-multiple" size={28} color="#3b5998" />
                            <Text className="text-sm text-gray-600 mt-2">Monto solicitado</Text>
                            <Text className="text-xl font-bold text-blue-600">${value.toFixed(2)}</Text>
                        </View>
                        <View className="w-[48%] bg-green-50 rounded-2xl p-4 mb-4">
                            <MaterialCommunityIcons name="calendar-clock" size={28} color="#2f855a" />
                            <Text className="text-sm text-gray-600 mt-2">Frecuencia de pago</Text>
                            <Text className="text-xl font-bold text-green-600">
                                {paymentPeriod === 'quincenal' ? 'Quincenal' : 'Semanal'}
                            </Text>
                        </View>
                        <View className="w-[48%] bg-purple-50 rounded-2xl p-4">
                            <MaterialCommunityIcons name="format-list-numbered" size={28} color="#6b46c1" />
                            <Text className="text-sm text-gray-600 mt-2">Número de cuotas</Text>
                            <Text className="text-xl font-bold text-purple-600">{numCuotas}</Text>
                        </View>
                        <View className="w-[48%] bg-orange-50 rounded-2xl p-4">
                            <MaterialCommunityIcons name="percent" size={28} color="#c05621" />
                            <Text className="text-sm text-gray-600 mt-2">Tasa de interés</Text>
                            <Text className="text-xl font-bold text-orange-600">5%</Text>
                        </View>
                    </View>
                ...
                <TouchableOpacity
                    className="bg-green-500 py-4 px-6 rounded-xl mt-8 flex-row justify-center items-center"
                    onPress={() => Haptics.notificationAsync(Haptics.NotificationFeedbackType.Success)}
                >
                    <Ionicons name="checkmark-circle-outline" size={24} color="white" />
                    <Text className="text-white text-xl font-bold ml-2">Solicitar Préstamo</Text>
                </TouchableOpacity>
            </Animated.View>
        </ScrollView>
    );
...
export default SolicitarCreditoScreen;